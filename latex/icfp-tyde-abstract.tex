...
%WOUTER - not used? never called?
Other than that, it is mostly unaffected by the presence of additional type invariants.
%WOUTER - I'm not sure I undertand this sentence - what
% is unaffected? what invariants are you referring to here?
% I'd suggest removing the sentence above.
...
% WOUTER - the \U is not formatting correctly in my build...
...
\begin{align*}
  ...
  \I{Let}
    :\ &\I{Expr}\ \Gamma\ \sigma \to
        ...
        \I{Expr}\ \Gamma\ \tau
\end{align*}
% WOUTER - perhaps add an explicit ... and clarify that this is a fragment of the
% Expr definition
...
%WOUTER - to which it has access (try not to end a sentence with a proposition)
...
% WOUTER - we can define a function floor : ....
...
\end{align*}
% WOUTER - give type signature of evalLive?

% WOUTER - To create such live expressions, we need to perform
% some static analysis of our source programs...
The function \I{analyse} now computes the live sub-context $\Delta'$
...
% counterpart in Expr.
The implementation does not contain more than the same case distinction and some renaming
...
% WOUTER - perhaps say that this is exactly the same as the ascending chain condition
